          ...
          <div class="flex items-center gap-2">
            <div class="flex items-center gap-1">
              <template v-if="themes.find((t) => t.theme === currentTheme)">
                <span
                  :style="{
                    '--theme-color': themes.find((t) => t.theme === currentTheme)?.colors.primary,
                  }"
                  class="size-2.5 rounded-full bg-[var(--theme-color)]"
                />
                <span
                  :style="{
                    '--theme-color': themes.find((t) => t.theme === currentTheme)?.colors.secondary,
                  }"
                  class="size-2.5 rounded-full bg-[var(--theme-color)] ring-1 ring-border/50"
                />
                <span
                  :style="{
                    '--theme-color': themes.find((t) => t.theme === currentTheme)?.colors.muted,
                  }"
                  class="size-2.5 rounded-full bg-[var(--theme-color)] ring-1 ring-border/50"
                />
                <span
                  :style="{
                    '--theme-color': themes.find((t) => t.theme === currentTheme)?.colors.accent,
                  }"
                  class="size-2.5 rounded-full bg-[var(--theme-color)]"
                />
                <span
                  :style="{
                    '--theme-color': themes.find((t) => t.theme === currentTheme)?.colors
                      .destructive,
                  }"
                  class="size-2.5 rounded-full bg-[var(--theme-color)]"
                />
